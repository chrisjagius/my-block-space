...
export default class MyProfile extends Component {
    ...
    render() {
            ...
            const friendDisplay = this.props.friends.length > 0 ? ( < div className = 'profile-posts' >
                ...
                ListGroup variant = "flush" > {
                    this.props.friends.map((friend) => ( <
                        ...
                        ListGroup.Item onClick = {
                            () => { this.props.searchFor(friend) }
                        } > { friend } < /ListGroup.Item> < /
                        Col > <
                        /Row> < /
                        div >
                    ))
                ...
                div > );
            return ( <
                div > {!isSignInPending() && person &&
                    <
                    div className = "container-myprofile" >
                    <
                    div style = { backgroundStyle }
                    className = 'container-desc-prof' >
                    <
                    Container >
                    <
                    ...
                    p className = 'text-secondary' > {
                        person.description() ? person.description() : 'You have no bio.'
                    } <
                    /p>  < /
                    Col > <
                    /Row> < /
                    ...
                    { this.state.displayFriends && friendDisplay } {
                        ...
                        md = { 8 } > {
                            ...
                            div > {
                                ...
                                onChange = { this.captureFileBackground }
                                hidden / >
                                <
                                /label> { '     ' } <
                                label class = "btn btn-outline-danger"
                                onClick = { this.defaultBackground } >
                                Default <
                                /label> < /
                                Col > <
                                /Form.Group> <
                            ...
                            img alt = ''
                            src = { cameraIcon }
                            /> <input type="file" onChange={this.captureFile} hidden/ >
                            <
                            /label> < /
                            Col > <
                            Col md = { 4 }
                            className = "text-right input-btn-wrapper" >
                            <
                        ...
                        md = { 8 } > {
                                ...
                                this.state.statuses.map((status) => ( <
                                        ...
                                        /Col> <
                                        Col xs = { 3 }
                                        className = 'poster-info' > { username } <
                                        /Col> <
                                        Col xs = { 4 } > < /Col> <
                                        Col xs = { 3 } >
                                        <
